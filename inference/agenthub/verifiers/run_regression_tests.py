...
from inference.logging import setup_logging
from inference.agenthub.agent.agent import AgentArgs
...
agent_args = AgentArgs.from_yaml(
    Path("./inference/agenthub/config/r2egym/edit_fn_calling.yaml")
)
swebv_dataset = (
